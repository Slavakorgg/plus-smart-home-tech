...
public class DeliveryFailedPoller extends AbstractPoller<Delivery> {
    ...
    protected Optional<Delivery> getEntity() {
        return deliveryRepository.findFirstByDeliveryStateOrderByTouchedAtAsc(DeliveryState.FAILED);
    }
